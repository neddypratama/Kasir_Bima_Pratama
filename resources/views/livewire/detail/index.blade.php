...
new class extends Component {
    ...
    public function delete($id): void
    {
        ...
        $kategori->delete();
        $this->warning("Laporan $kategori->name akan dihapus", position: 'toast-top');
    }
    ...
    {
        $this->editingRole = Laporan::find($id);
...
<div>
    <!-- HEADER -->
    <x-header title="Daftar Laporan" separator progress-indicator>
        <x-slot:actions>
