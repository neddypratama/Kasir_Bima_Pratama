...
new class extends Component {
    ...
    public function updatedTanggal($value): void
    {
        ...
        $this->invoice = "INV-$tanggal-STK-$rand";
    }
    ...
    */
    ...
    public function save(): void
    {
        ...
        $this->success('Transaksi pembelian berhasil disimpan (FIFO)', redirectTo: '/supplier');
    }
            ...
            <div class="lg:grid grid-cols-8 gap-4">
                ...
                <div class="col-span-6 space-y-4">
                    ...
                    <div class="border-t pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <x-input label="Kekurangan" value="Rp {{ number_format(max(0, $total - $uang), 0, '.', ',') }}"
