...
new class extends Component {
    ...
    public function with(): array
    {
        ...
        return [
            ...
            'client' => Client::where('keterangan', 'Supplier')->get(),
...
<div class="p-4 space-y-6">
    <x-header title="Transaksi Pembelian" separator progress-indicator>
        <x-slot:actions>
            <div class="flex flex-row sm:flex-row gap-2">
                ...
                <x-button label="Create" link="/supplier/create" responsive icon="o-plus" class="btn-primary" />
            </div>
        </x-slot:actions>
    </x-header>
    ...
    <x-card class="overflow-x-auto">
        <x-table :headers="$headers" :rows="$transaksi" :sort-by="$sortBy" with-pagination
            link="supplier/{id}/show?invoice={invoice}">
                ...
                <div class="flex">
                    ...
                    @if (Auth::user()->role_id == 1 ||
                        ...
                        <x-button icon="o-pencil"
                            link="/supplier/{{ $transaksi->id }}/edit?invoice={{ $transaksi->invoice }}"
                    ...
                    <x-button icon="o-printer" link="/supplier/{{ $transaksi->id }}/print"
